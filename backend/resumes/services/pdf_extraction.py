...
# Mirrors jobs/services/pdf_extraction.py by design, since both apps run the
# identical pdfplumber pipeline; suppress the cross-file duplicate-code report
# until that flow is extracted.
